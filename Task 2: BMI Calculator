...
def calculate():
    ...
    animate_widget(bmi_label, [("background", "cyan"), ("background", "SystemButtonFace")])
    animate_widget(category_label, [("background", "orange"), ("background", "SystemButtonFace")])
    animate_widget(weight_range_label, [("background", "lime"), ("background", "SystemButtonFace")])
